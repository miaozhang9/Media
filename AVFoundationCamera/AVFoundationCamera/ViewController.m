...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.viewContainer.frame = CGRectMake(20, self.viewContainer.frame.origin.y + 20, self.viewContainer.frame.size.width - 40, self.viewContainer.frame.size.height - 40);
